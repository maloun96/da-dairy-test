  ...
  ({
    ...
    return (
      <View style={wrapperStyle}>
        <TextComponent
          style={StyleSheet.flatten([Array.isArray(style) ? StyleSheet.flatten(style) : style, styles.hiddenText])}
        ...
        {seeMore && collapsed && afterCollapsed && (
          <View style={styles.seeMoreContainer}>
            <TouchableOpacity onPress={toggle} style={[styles.seeMoreButton, { backgroundColor }]}>
